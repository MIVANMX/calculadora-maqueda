  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div style={{
        ...
        {/* Footer */}
        <p style={{ fontSize: '12px', color: '#3d5a73', position: 'relative', zIndex: 1 }}>
          © 2026 Inmobiliaria Maqueda. Acceso privado.
        </p>
      </div>
        ...
        <div style={{ width: '100%', maxWidth: '360px' }}>
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom: '16px' }}>
              ...
              <input
                ...
                style={{ width: '100%', border: '1.5px solid #e5e7eb', borderRadius: '10px', padding: '11px 14px', fontSize: '14px', color: '#0D1B2A', outline: 'none', boxSizing: 'border-box', background: '#ffffff', transition: 'border-color 0.2s' }}
            ...
            <button
              type="submit"
              disabled={loading}
              style={{ width: '100%', background: loading ? '#93afd4' : '#1B3A6B', color: '#ffffff', border: 'none', borderRadius: '10px', padding: '13px', fontSize: '14px', fontWeight: '600', cursor: loading ? 'not-allowed' : 'pointer', transition: 'all 0.2s', letterSpacing: '0.3px' }}
          ...
          <div style={{ marginTop: '32px', paddingTop: '24px', borderTop: '1px solid #e5e7eb' }}>
            <p style={{ fontSize: '12px', color: '#9ca3af', textAlign: 'center', margin: 0 }}>
              Acceso exclusivo para el equipo Maqueda
            </p>
          </div>
        </div>
      </div>
